...
import com.fast.core.fast_core.ui.picture.select_multi_pictures.adapter.PicturePickerAdapter;
import com.fast.core.fast_core.ui.picture.select_multi_pictures.adapter.PopupWindowSelectDirAdapter;
...
//        把这个FolderBean放在了集合的第一个
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == YuLanActivity.RESULT_CODE_SELECTED_PATH_LIST_YU_LAN_FINISH) {
            setResult(RESULT_CODE_SELECTED_PATH_LIST_FINISH);
