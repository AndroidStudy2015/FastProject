...
public class RestClientBuilder {
    ...
    private IDownloading mIDownloading = null;
    private IDownloadIncomplete mIDownloadIncomplete;
    ...
    public final RestClientBuilder downLoading(IDownloading iDownloading) {
        this.mIDownloading = iDownloading;
        return this;
    }
    public final RestClientBuilder downloadIncomplete(IDownloadIncomplete iDownloadIncomplete) {
        this.mIDownloadIncomplete= iDownloadIncomplete;
        return this;
    }
