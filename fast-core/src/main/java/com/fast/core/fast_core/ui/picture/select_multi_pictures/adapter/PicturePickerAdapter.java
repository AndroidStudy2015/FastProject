...
import com.fast.core.fast_core.ui.picture.select_multi_pictures.activity.PicturePickerActivity;
...
public class PicturePickerAdapter extends RecyclerView.Adapter<PicturePickerAdapter.FirstViewHolder> {
    ...
    public FirstViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new FirstViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_pic_picker_multi, parent, false));
    }
